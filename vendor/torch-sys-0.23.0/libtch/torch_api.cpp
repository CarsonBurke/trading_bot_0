...
void at_sdp_set_use_flash(bool b) {
  PROTECT(
    at::globalContext().setSDPUseFlash(b);
  )
}

bool at_sdp_use_flash() {
  PROTECT(
    return at::globalContext().userEnabledFlashSDP();
  )
  return false;
}
...
void at_sdp_set_use_mem_efficient(bool b) {
  PROTECT(
    at::globalContext().setSDPUseMemEfficient(b);
  )
}

bool at_sdp_use_mem_efficient() {
  PROTECT(
    return at::globalContext().userEnabledMemEfficientSDP();
  )
  return false;
}
...
void at_sdp_set_use_math(bool b) {
  PROTECT(
    at::globalContext().setSDPUseMath(b);
  )
}

bool at_sdp_use_math() {
  PROTECT(
    return at::globalContext().userEnabledMathSDP();
  )
  return false;
}
...
void at_sdp_set_use_cudnn(bool b) {
  PROTECT(
    at::globalContext().setSDPUseCuDNN(b);
  )
}

bool at_sdp_use_cudnn() {
  PROTECT(
    return at::globalContext().userEnabledCuDNNSDP();
  )
  return false;
}
