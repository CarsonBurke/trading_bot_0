pub const TICKERS_COUNT: i64 = 6;
pub const ACTION_HISTORY_LEN: usize = 20;
pub const PRICE_DELTAS_PER_TICKER: usize = 3400;
/// Static observations: step (1) + cash_percent (1) + position_percents (TICKER_COUNT) + position_time_weighted_returns (TICKER_COUNT) + action_history (TICKER_COUNT * ACTION_HISTORY_LEN * 2)
pub const STATIC_OBSERVATIONS: usize = 1 + 1 + TICKERS_COUNT as usize + TICKERS_COUNT as usize + (ACTION_HISTORY_LEN * TICKERS_COUNT as usize * 2);
